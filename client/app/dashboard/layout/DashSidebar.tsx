    ...
    items: [
      {
        ...
        icon: PieChart,
        href: "/dashboard/budgeting/spending-analysis",
        tone: "live",
      },
      {
        ...
        icon: TrendingUp,
        href: "/dashboard/budgeting/income-vs-expense",
        tone: "live",
      },
      {
        title: "Cash Flow",
        ...
        icon: BarChart3,
        href: "/dashboard/budgeting/cash-flow",
        tone: "live",
      },
      {
        ...
        icon: FileText,
        badge: "Soon",
        href: "/dashboard/budgeting/custom-reports",
        tone: "live",
      },
    ],
  },
