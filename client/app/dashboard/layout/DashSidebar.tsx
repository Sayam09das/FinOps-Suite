  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Wallet,
        href: "/dashboard/accounts/wallets",
        badge: "Live",
        tone: "live",
      },
      {
        ...
        icon: CreditCard,
        href: "/dashboard/accounts/credit-cards",
        badge: "Live",
        tone: "live",
      },
      {
        ...
        icon: ArrowRightLeft,
        href: "/dashboard/accounts/transfers",
        badge: "Live",
        tone: "live",
      },
    ],
    ...
    items: [
      {
        ...
        icon: PiggyBank,
        href: "/dashboard/budgeting/create",
        badge: "Live",
        tone: "live",
      },
      {
        ...
        icon: TrendingUp,
        href: "/dashboard/budgeting/monthly",
        badge: "Live",
        tone: "live",
      },
      {
        ...
        icon: BarChart3,
        href: "/dashboard/budgeting/vs-actual",
        badge: "Live",
        tone: "live",
      },
    ],
    ...
    items: [
      {
        ...
        icon: PieChart,
        href: "/dashboard/analytics/spending",
        badge: "Live",
        tone: "live",
      },
      {
        ...
        icon: TrendingUp,
        href: "/dashboard/analytics/income-vs-expense",
        badge: "Live",
        tone: "live",
      },
      {
      ...
      },
      {
        ...
        icon: FileText,
        href: "/dashboard/analytics/custom-reports",
        badge: "Live",
        tone: "live",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: TrendingUp,
        href: "/dashboard/goals/investments",
        badge: "Live",
        tone: "live",
      },
      {
    ...
    items: [
      {
        ...
        icon: Users,
        href: "/dashboard/collaboration/shared-accounts",
        badge: "Live",
        tone: "live",
      },
      {
        ...
        icon: ReceiptText,
        href: "/dashboard/collaboration/group-expenses",
        badge: "Live",
        tone: "live",
      },
      {
        ...
        icon: UserPlus,
        href: "/dashboard/collaboration/invite-users",
        badge: "Live",
        tone: "live",
      },
    ],
