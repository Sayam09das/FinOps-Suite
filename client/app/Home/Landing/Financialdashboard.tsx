                ...
                <CardContent>
                  <div className="flex flex-wrap items-end justify-between gap-4">
                    <div className="space-y-2">
                      ...
                      <p className="text-3xl font-semibold tracking-[-0.05em] text-foreground">$247k within plan</p>
                    </div>
                ...
                <CardContent>
                  <div className="flex items-end justify-between gap-3">
                    {months.map((month, index) => (
                      <Reveal key={month.label} delay={0.04 * index} variant="up" className="flex flex-1 flex-col items-center gap-3">
                        <div className="flex h-36 w-full items-end">
                          <div className={`w-full rounded-t-[1rem] bg-gradient-to-t from-foreground via-primary to-primary/40 ${month.height}`} />
                        </div>
                        <span className="text-xs font-medium uppercase tracking-[0.16em] text-foreground/45">{month.label}</span>
                      </Reveal>
                    ))}
                  </div>
                </CardContent>
